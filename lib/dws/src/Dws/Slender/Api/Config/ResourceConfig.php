 ...
 * resource config array (@see start/app.php)
 *
...
class ResourceConfig
{
    ...
    public function getConfigBySite($site)
    {
        if (!$site) {
            ...
            return $this->config['per-site'][$site] ?: null;
        }
    }
    ...
    {
        if (!$site) {
            return $this->config[$resource] ?: null;
        } else {
            return $this->config[$site][$resource] ?: null;
        }
    }
    ...
    {
        $resourceData = $this->getAllResourceBySite($resource, $site);
        if (!$resourceData) {
            return null;
        }
        return $resourceData['model']['class'] ?: $this->getClassResolver()->createResourceModelClassName($resource, $site);
    }
    ...
    public function getResourceControllerClassForSite($resource, $site = null)
    {
        ...
        return $resourceData['controller']['class'] ?: $this->getClassResolver()->createResourceControllerClassName($resource, $site);
    }
